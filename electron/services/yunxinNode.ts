...
import type { YunxinSdk, YunxinSdkFactory } from "../../src/infrastructure/channels/YunxinWebChannelTransport";
...
function configureAdapters(runtime: YunxinRuntime): void {
  ...
  runtime.setAdapters(() => ({
    ...
    logStorage: class {
      ...
      close(): void {}
      addLogs(): Promise<void> { return Promise.resolve(); }
      extractLogs(): Promise<void> { return Promise.resolve(); }
      afterUpload(): Promise<void> { return Promise.resolve(); }
    },
  }));
  configured = true;
}
...
function registerServices(runtime: YunxinRuntime): void {
  ...
  runtime.NIM.registerService(runtime.V2NIMLocalConversationService, "V2NIMLocalConversationService");
  runtime.NIM.registerService(runtime.V2NIMConversationGroupService, "V2NIMConversationGroupService");
