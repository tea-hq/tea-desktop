...
const emptyState: AgentDrawerChannelState = {
  ...
  draft: {
    ...
    attachments: [],
    sources: [],
    creationIdempotencyKey: 'drawer:story',
    conversationId: null,
  },
}
const conversations: ConversationSummary[] = Array.from({ length: 10 }, (_, index) => ({
  ...
  lastMessagePreview: 'Reviewing the current implementation and interaction details.',
  createdAt: index,
  updatedAt: index,
