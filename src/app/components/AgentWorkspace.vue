...
<template>
  ...
  <main class="min-w-0 flex-1">
    <AgentConversationSurface
      ...
      :agent-mode="conversation.executionTarget"
      :runner-tags="conversation.runnerTags"
      :cloud-runner-tags="conversation.cloudRunnerTags"
      ...
      @update:agent-mode="conversation.setExecutionTarget($event)"
      @update:runner-tag="conversation.selectRunnerTag($event)"
