...
<template>
  <select
    ...
    :disabled="disabled"
    :class="[
      'w-full appearance-none border border-line bg-canvas px-2.5 text-fg outline-none transition-colors focus:border-accent focus:ring-2 focus:ring-accent/20 disabled:cursor-not-allowed disabled:bg-muted disabled:text-disabled motion-reduce:transition-none',
